...
class TKNhuanButCommonByMonth extends FormBase {
  /**
  ...
  public function getFormId() {
    return 'tk_nhuan_but_common_by_month';
  }
  ...
  public function submitSearchForm(array &$form, FormStateInterface $form_state) {
    ...
    $tk_nb = \Drupal::service('cttdt_dashboard.dashboard')->getNBGroupUserCommon($month);
    ...
    if (empty($tk_nb)) {
      ...
      foreach ($tk_nb as $item) {
        ...
        $result .= '<tr class="post-item">
                      ...
                      <td class="text-align-center">'.$item['post_created'].'</td>
                      <td class="text-align-center">'.$item['hs_nhuan_but'].'</td>
                    </tr>';
      }

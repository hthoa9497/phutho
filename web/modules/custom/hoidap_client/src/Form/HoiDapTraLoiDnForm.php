...
/**
 * Class HoiDapTraLoiDnForm.
 */
class HoiDapTraLoiDnForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $response = \Drupal::httpClient()
      ->get('https://'.$host.'/hoi-dap-dn/'.$hoi_dap_id);
    ...
    if (!empty($hoi_dap)) {
      ...
      if ($is_dv) {
        $form['doanh_nghiep'] = [
          '#type' => 'textfield',
          '#title' => $this->t('Doanh nghiệp'),
          '#required' => TRUE,
          '#attributes' => array('readonly' => 'readonly'),
          '#default_value' => $hoi_dap->doanh_nghiep
        ];
        $form['dia_chi'] = [
          '#type' => 'textfield',
